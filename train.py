...
def main():
    ...
    best_val_psnr = 0.0
    writer = SummaryWriter(log_dir="logs/Color_Enhancement_0708")
    ...
    for epoch in range(num_epochs):
        ...
        if val_psnr > best_val_psnr:
            ...
            save_path = f'saved_train_models/Color_Enhancement_0708/ColorEnhance_epoch{epoch + 1:04d}_valpsnr{best_val_psnr:.4f}.pth'
